...
export function CyclesContextProvider({ children }: CyclesContextPoviderProps) {
  ...
  const [amountSecondsPassed, setAmountSecondsPassed] = useState<number>(() => {
    if (activeCycle) {
      return differenceInSeconds(new Date(), new Date(activeCycle.satrtDate))
    }
  ...
  useEffect(() => {
    ...
    localStorage.setItem('@timer-focu:cycles-state-1.0.0', stateJSON)
  }, [cyclesState])
  ...
  function markCurrentCycleFineshed() {
    dispatch(markCurrentCycleFineshed())
  }
